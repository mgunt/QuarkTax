            /*!
             * SimpliTax v. 3
             * Copyright 2016-2019 Michael Gunter
      ...
      function clearButton () {
              ...
              *************************************************************************************************************/
              ...
              //This code clears the output
              document.getElementById("taxTitle").innerHTML = "";
              document.getElementById("taxEstimate").innerHTML = "";
              document.getElementById("taxBracket").innerHTML = "";
              document.getElementById("taxPercentage").innerHTML = "";
      ...
      function calculateTax(){
        ...
        ***********************************************************************************************/
         ...
         var percentTaxed; // percentage of income that is taxed
         ...
         //0-Single, 1-Married Jointly, 2-Married Separately, and 3-Head of Household
            ...
            // Compute tax for "Married Jointly"
               if (income <= 19050){
                 ...
                 taxRate = 32;
                  ...
                  tax = 19050 * 0.10 + (77400 - 19050) * 0.12 +
                        (165000 - 77400) * 0.22 + (315000 - 165000) * 0.24 +
                        (200000 - 315000) * 0.32 + (income - 200000) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax = 19050 * 0.10 + (77400 - 19050) * 0.12 +
                        (165000 - 77400) * 0.22 + (315000 - 165000) * 0.24 +
                        (200000 - 315000) * 0.32 + (600000 - 200000) * 0.35 + (income - 600000) * 0.37;
                  taxRate = 37;
                }//end of else
          ...
          /***************************************************************************************
           * Explanation of Code:
           *                This section of code calculates the percentage of income that is
           *                taxed. This section of the code also rounds the tax variable to
           *                two decimal places.
           * ************************************************************************************/

           percentTaxed = (tax / income) * 100;
           tax = tax.toFixed(2);

          /***************************************************************************************
           * Explanation of Code:
           *                This section of the code displays the result for the title, the taxes
           *                calculated and the tax bracket the user falls in based on their income.
           *
          ...
          document.getElementById("taxTitle").innerHTML = "Your 2018 tax rate:";

          document.getElementById("taxEstimate").innerHTML = "Tax:  <b>$" + tax.toLocaleString() + "<b></br>";

          document.getElementById("taxPercentage").innerHTML = "Tax as % of Income:  <b>" + percentTaxed.toFixed(2) + "%<b></br>";
